...
const routes = [
  ...
  ['/docs/operate/api-key-rotation', 'Rotate API keys'],
  ['/docs/operate/certificates', 'Manage certificates'],
  ['/docs/operate/first-deployment', 'First deployment'],
  ['/docs/operate/deploy', 'Deploy and roll back'],
  ['/docs/operate/edges', 'Manage edge servers'],
  ['/docs/operate/backup-restore', 'Back up and restore'],
  ['/docs/operate/troubleshooting', 'Troubleshoot and repair'],
  ['/docs/operate/production', 'Production maintenance'],
  ['/docs/operate/security', 'Verify security controls'],
  ...
  ['/docs/operate/http-api', 'Automate with the HTTP API'],
  ['/docs/understand/security', 'Security boundaries'],
  ['/docs/reference', 'Reference'],
  ['/docs/reference/cli', 'CLI'],
  ['/docs/reference/configuration', 'Configuration'],
  ['/docs/reference/records', 'Domains, records, and sites'],
  ['/docs/reference/ansible', 'Ansible roles and variables'],
  ['/docs/reference/http-api', 'HTTP API'],
  ['/docs/reference/http-api-models', 'HTTP API models'],
  ['/docs/operate/go-live', 'Take a real site live'],
  ['/docs/operate/dns', 'Publish DNS'],
  ['/docs/operate/incident-response', 'Respond to incidents'],
]
